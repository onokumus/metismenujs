...
- [API](#api)
    ...
    + [update](#update)
- [Events](#events)
- [Migrating to v1.0.3 from v1.1.0](#migrating-to-v103-from-v110)
- [Demo](#demo)
- [About](#about)
...
_This file was generated by [verb-generate-readme](https://github.com/verbose/verb-generate-readme), v0.8.0, on July 25, 2019._
